...
你可以在[渲染机制]章节了解更多关于 Vue 如何自动优化运行时性能的信息，也可以在[性能优化指南]中了解如何在特别苛刻的情况下优化 Vue 应用。
...
如果你是 Vue 的新手，我们在[这里]提供了一个两者之间宏观的比较。

如果你过去使用过选项式 API 且正在评估组合式 API，可以查阅[常见问题]。
...
Vue 还完全支持消费或导出到原生自定义元素——查看 [Vue 和 Web Components 指南]以了解更多细节。
